...
public class TransactionController {
    ...
    @PostMapping("/transfer/initiation")
    public Mono<ResponseEntity<TransferResponse>> initiateTransaction(
            @Valid @RequestBody TransferRequestInitiation request) {
    ...
    @PostMapping("/transfer/execution")
    public Mono<ResponseEntity<TransferResponse>> executeTransaction(
            @Valid @RequestBody TransferRequestExecution request) {
